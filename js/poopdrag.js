...
(function ( $ ) {
  ...
  $(document).mouseup(function (e) {
	...
	$(TheDraggable).css({
	  'transition':'all 1000ms cubic-bezier(0.140, 0.715, 0.300, 0.905)'
	}) ;
    TheDraggable.css({
      'top': TheTop - YDiff + (momentumY2 - momentumY1)*3,
      'left': TheLeft - XDiff + (momentumX2 - momentumX1)*3
    });
  ...
  $.fn.glideDrag = function() {
    ...
    */
    ...
    this.mousedown(function (e) {
      ...
      XDiff = e.pageX - $(this).position().left ;
      YDiff = e.pageY - $(this).position().top ;
